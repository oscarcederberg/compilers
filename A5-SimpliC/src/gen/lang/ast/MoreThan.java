...
/**
 * @ast node
 * @declaredat /home/knos/repos/education/p021-oscar-kasper/A5-SimpliC/src/jastadd/lang.ast:36
...
public class MoreThan extends BinOp implements Cloneable {
  /**
   * @aspect Interpreter
   * @declaredat /home/knos/repos/education/p021-oscar-kasper/A5-SimpliC/src/jastadd/Interpreter.jrag:138
   */
  ...
  /**
   * @aspect PrettyPrint
   * @declaredat /home/knos/repos/education/p021-oscar-kasper/A5-SimpliC/src/jastadd/PrettyPrint.jrag:155
   */
  ...
  public MoreThan(Expr p0, Expr p1) {
    setChild(p0, 0);
    setChild(p1, 1);
  }
  /** @apilevel low-level 
   ...
   */
  public MoreThan clone() throws CloneNotSupportedException {
    MoreThan node = (MoreThan) super.clone();
    return node;
  }
  /** @apilevel internal 
   * @declaredat ASTNode:42
   */
  public MoreThan copy() {
    try {
      MoreThan node = (MoreThan) clone();
      node.parent = null;
      if (children != null) {
   ...
   */
  public MoreThan treeCopyNoTransform() {
    MoreThan tree = (MoreThan) copy();
    if (children != null) {
   ...
   * @apilevel high-level
   */
  public MoreThan setLeft(Expr node) {
    setChild(node, 0);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public MoreThan setRight(Expr node) {
    setChild(node, 1);
    return this;
  }
  /**
...
protected boolean expectedType_visited = false;
   ...
   * @attribute syn
   * @aspect TypeAnalysis
   * @declaredat /home/knos/repos/education/p021-oscar-kasper/A5-SimpliC/src/jastadd/TypeAnalysis.jrag:32
   */

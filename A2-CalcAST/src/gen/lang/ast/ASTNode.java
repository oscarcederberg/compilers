...
public class ASTNode<T extends ASTNode> extends beaver.Symbol implements Cloneable {
  /**
   * @aspect DumpTree
   * @declaredat /mnt/d/coursework/edan65-compilers/assignments/A2-CalcAST/src/jastadd/DumpTree.jrag:9
   */
  private static final String DUMP_TREE_INDENT = "  ";
  /**
   * @aspect DumpTree
   * @declaredat /mnt/d/coursework/edan65-compilers/assignments/A2-CalcAST/src/jastadd/DumpTree.jrag:11
   */
  ...
  /**
   * @aspect DumpTree
   * @declaredat /mnt/d/coursework/edan65-compilers/assignments/A2-CalcAST/src/jastadd/DumpTree.jrag:17
   */
  ...
  /**
   * @aspect DumpTree
   * @declaredat /mnt/d/coursework/edan65-compilers/assignments/A2-CalcAST/src/jastadd/DumpTree.jrag:22
   */
  ...
  /**
   * @aspect DumpTree
   * @declaredat /mnt/d/coursework/edan65-compilers/assignments/A2-CalcAST/src/jastadd/DumpTree.jrag:35
   */

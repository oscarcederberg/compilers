...
/**
 * @ast node
 * @declaredat /home/knos/repos/education/p021-oscar-kasper/A6-SimpliC/src/jastadd/lang.ast:33
...
public class NotEq extends BinOp implements Cloneable {
  /**
   * @aspect CodeGen
   * @declaredat /home/knos/repos/education/p021-oscar-kasper/A6-SimpliC/src/jastadd/CodeGen.jrag:259
   */
  ...
  /**
   * @aspect Interpreter
   * @declaredat /home/knos/repos/education/p021-oscar-kasper/A6-SimpliC/src/jastadd/Interpreter.jrag:168
   */
  ...
  /**
   * @aspect PrettyPrint
   * @declaredat /home/knos/repos/education/p021-oscar-kasper/A6-SimpliC/src/jastadd/PrettyPrint.jrag:140
   */
   ...
   */
  public NotEq clone() throws CloneNotSupportedException {
    NotEq node = (NotEq) super.clone();
    return node;
  }
  /** @apilevel internal 
   ...
   */
  public NotEq treeCopyNoTransform() {
    NotEq tree = (NotEq) copy();
    if (children != null) {
   ...
   * @apilevel high-level
   */
  public NotEq setLeft(Expr node) {
    setChild(node, 0);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public NotEq setRight(Expr node) {
    setChild(node, 1);
    return this;
  }
  /**
...
protected boolean expectedType_visited = false;
   ...
   * @attribute syn
   * @aspect TypeAnalysis
   * @declaredat /home/knos/repos/education/p021-oscar-kasper/A6-SimpliC/src/jastadd/TypeAnalysis.jrag:29
   */

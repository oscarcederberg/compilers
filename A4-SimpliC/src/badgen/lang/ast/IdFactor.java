 ...
 * @astdecl IdFactor : Factor ::= <ID:String>;
 * @production IdFactor : {@link Factor} ::= <span class="component">&lt;ID:{@link String}&gt;</span>;
...
public class IdFactor extends Factor implements Cloneable {
  ...
  public IdFactor(String p0) {
    setID(p0);
  }
  /**
   * @declaredat ASTNode:20
   */
  public IdFactor(beaver.Symbol p0) {
    setID(p0);
  }
  /** @apilevel low-level 
   ...
   * @apilevel high-level
   */
  public IdFactor setID(String value) {
   ...
   * @apilevel internal
   */
  public IdFactor setID(beaver.Symbol symbol) {

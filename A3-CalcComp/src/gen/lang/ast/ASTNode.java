...
public class ASTNode<T extends ASTNode> extends beaver.Symbol implements Cloneable {
  /**
   * @aspect DumpTree
   * @declaredat /mnt/d/coursework/edan65-compilers/assignments/A3-CalcComp/src/jastadd/DumpTree.jrag:9
   */
  private static final String DUMP_TREE_INDENT = "  ";
  /**
   * @aspect DumpTree
   * @declaredat /mnt/d/coursework/edan65-compilers/assignments/A3-CalcComp/src/jastadd/DumpTree.jrag:11
   */
  ...
  /**
   * @aspect DumpTree
   * @declaredat /mnt/d/coursework/edan65-compilers/assignments/A3-CalcComp/src/jastadd/DumpTree.jrag:17
   */
  ...
  /**
   * @aspect DumpTree
   * @declaredat /mnt/d/coursework/edan65-compilers/assignments/A3-CalcComp/src/jastadd/DumpTree.jrag:22
   */
  ...
  /**
   * @aspect DumpTree
   * @declaredat /mnt/d/coursework/edan65-compilers/assignments/A3-CalcComp/src/jastadd/DumpTree.jrag:35
   */
   ...
   * @aspect NameAnalysis
   * @declaredat /mnt/d/coursework/edan65-compilers/assignments/A3-CalcComp/src/jastadd/NameAnalysis.jrag:65
   */
   ...
   * @aspect NameAnalysis
   * @declaredat /mnt/d/coursework/edan65-compilers/assignments/A3-CalcComp/src/jastadd/NameAnalysis.jrag:108
   */
  public int getLine() {
  ...
  /**
   * @aspect PrettyPrint
   * @declaredat /mnt/d/coursework/edan65-compilers/assignments/A3-CalcComp/src/jastadd/PrettyPrint.jrag:4
   */
  ...
  /**
   * @aspect PrettyPrint
   * @declaredat /mnt/d/coursework/edan65-compilers/assignments/A3-CalcComp/src/jastadd/PrettyPrint.jrag:9
   */
  ...
  /**
   * @aspect Visitor
   * @declaredat /mnt/d/coursework/edan65-compilers/assignments/A3-CalcComp/src/jastadd/Visitor.jrag:20
   */
